...
class Tratamiento {
	...
	*/
	...
	Tratamiento(std::string const &fechaInicio ="", std::string const &fechaFin ="", std::string const &periodicidad ="", std::string const &dosis ="")
	{
	...
	*/
	...
	/*!		
		\brief Lee por teclado los datos de un tratamiento    
		\pre   Ninguna
		\post  Se modifican los atributos del tratamiento usando valores introducidos por el teclado
	*/
	void leerTratamiento();
	
	/*!		
		\brief Imprime por pantalla los datos de un tratamiento    
		\pre   El tratamiento debe tener sus datos cumplimentados
		\post  Ninguna
	*/
	void escribirTratamiento();
